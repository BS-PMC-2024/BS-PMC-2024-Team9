...
import { HistoricalTickBidAsk, TickAttribBidAsk } from "./historical/historicalTickBidAsk";
import { HistoricalTickLast, TickAttribLast } from "./historical/historicalTickLast";
...
export declare const MAX_SUPPORTED_SERVER_VERSION = MIN_SERVER_VER.PROFESSIONAL_CUSTOMER;
/** Minimum supported version. */
export declare const MIN_SERVER_VER_SUPPORTED = 38;
/**
 ...
 * details.
 */
export declare class IBApi extends EventEmitter {
    /**
     ...
     * @param reqId The unique request identifier.
     */
    reqCancelWshMetaData(reqId: number): this;
    /**
     ...
     * @param reqId The unique request identifier.
     */
    reqCancelWshEventData(reqId: number): this;
    /**
     ...
     */
    reqHistoricalData(reqId: number, contract: Contract, endDateTime: string, durationStr: string, barSizeSetting: BarSizeSetting, whatToShow: WhatToShow, useRTH: number | boolean, formatDate: number, keepUpToDate: boolean): IBApi;
    /**
     ...
     */
    reqHistoricalTicks(reqId: number, contract: Contract, startDateTime: string, endDateTime: string, numberOfTicks: number, whatToShow: WhatToShow, useRTH: number | boolean, ignoreSize: boolean): IBApi;
    /**
     ...
     */
    reqScannerSubscription(reqId: number, subscription: ScannerSubscription, scannerSubscriptionOptions?: TagValue[], scannerSubscriptionFilterOptions?: TagValue[]): IBApi;
    /**
...
export declare interface IBApi {
     ...
     */
    on(event: EventName.error, listener: (error: Error, code: ErrorCode, reqId: number, advancedOrderReject?: unknown) => void): this;
    /**
     ...
     */
    on(event: EventName.completedOrder, listener: (contract: Contract, order: Order, orderState: OrderState) => void): this;
    /**
     ...
     */
    on(event: EventName.error, listener: (id: number, errorCode: number, errorMsg: string, advancedOrderReject?: unknown) => void): this;
    /**
     ...
     * @see [[reqHistoricalData]]
     */
    on(event: EventName.historicalDataUpdate, listener: (reqId: number, time: string, open: number, high: number, low: number, close: number, volume: number, count: number, WAP: number) => void): this;
     ...
     * @see [[reqMarketRule]]
     */
    on(event: EventName.marketRule, listener: (marketRuleId: number, priceIncrements: unknown[]) => void): this;
    /**
     ...
     * @see [[reqSinglePnL]]
     */
    on(event: EventName.pnlSingle, listener: (reqId: number, pos: number, dailyPnL: number, unrealizedPnL: number | undefined, realizedPnL: number | undefined, value: number) => void): this;
    /**
     ...
     * @see [[reqTickByTickData]]
     */
    on(event: EventName.tickByTickAllLast, listener: (reqId: number, tickType: number, time: number, price: number, size: number, tickAttribLast: TickAttribLast, exchange: string, specialConditions: string) => void): this;
    /**
     ...
     * @see [[reqTickByTickData]]
     */
    on(event: EventName.tickByTickBidAsk, listener: (reqId: number, time: number, bidPrice: number, askPrice: number, bidSize: number, askSize: number, tickAttribBidAsk: TickAttribBidAsk) => void): this;
    /**
