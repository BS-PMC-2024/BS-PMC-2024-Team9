...
describe("IBApi Historical data Tests", () => {
    ...
    test("Option market data", (done) => {
        ...
        ib.once(__1.EventName.connected, () => {
            ...
            ib.reqHistoricalData(refId, contract, "20240508-17:00:00", "30 S", __1.BarSizeSetting.SECONDS_FIFTEEN, __1.WhatToShow.BID_ASK, 0, 2, false);
        })
            .on(__1.EventName.historicalData, (reqId, time, open, high, low, close, volume, count, WAP) => {
            // console.log(
            //   counter,
    ...
    it("Test request tick history", (done) => {
        ...
        ib.connect().reqHistoricalTicks(refId, contracts_1.sample_etf, "20240508-17:00:00", null, 10, __1.WhatToShow.TRADES, 0, true);
    });
});
