...
export declare class Encoder {
     ...
     */
    reqHistoricalData(tickerId: number, contract: Contract, endDateTime: string, durationStr: string, barSizeSetting: BarSizeSetting, whatToShow: WhatToShow, useRTH: number | boolean, formatDate: number, keepUpToDate: boolean, chartOptions?: TagValue[]): void;
    /**
     * Encode a REQ_HISTORICAL_TICKS message.
     */
    reqHistoricalTicks(tickerId: number, contract: Contract, startDateTime: string, endDateTime: string, numberOfTicks: number, whatToShow: WhatToShow, useRth: number | boolean, ignoreSize: boolean, miscOptions?: TagValue[]): void;
    /**
