...
exports.Encoder = exports.OUT_MSG_ID = void 0;
const market_scanner_1 = require("../../api-next/market-scanner/market-scanner");
const fa_data_type_1 = __importDefault(require("../../api/data/enum/fa-data-type"));
...
const order_1 = require("../../api/order/order");
...
var OUT_MSG_ID;
(function (OUT_MSG_ID) {
    OUT_MSG_ID[OUT_MSG_ID["REQ_MKT_DATA"] = 1] = "REQ_MKT_DATA";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_MKT_DATA"] = 2] = "CANCEL_MKT_DATA";
    OUT_MSG_ID[OUT_MSG_ID["PLACE_ORDER"] = 3] = "PLACE_ORDER";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_ORDER"] = 4] = "CANCEL_ORDER";
    OUT_MSG_ID[OUT_MSG_ID["REQ_OPEN_ORDERS"] = 5] = "REQ_OPEN_ORDERS";
    OUT_MSG_ID[OUT_MSG_ID["REQ_ACCOUNT_DATA"] = 6] = "REQ_ACCOUNT_DATA";
    OUT_MSG_ID[OUT_MSG_ID["REQ_EXECUTIONS"] = 7] = "REQ_EXECUTIONS";
    OUT_MSG_ID[OUT_MSG_ID["REQ_IDS"] = 8] = "REQ_IDS";
    OUT_MSG_ID[OUT_MSG_ID["REQ_CONTRACT_DATA"] = 9] = "REQ_CONTRACT_DATA";
    OUT_MSG_ID[OUT_MSG_ID["REQ_MKT_DEPTH"] = 10] = "REQ_MKT_DEPTH";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_MKT_DEPTH"] = 11] = "CANCEL_MKT_DEPTH";
    OUT_MSG_ID[OUT_MSG_ID["REQ_NEWS_BULLETINS"] = 12] = "REQ_NEWS_BULLETINS";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_NEWS_BULLETINS"] = 13] = "CANCEL_NEWS_BULLETINS";
    OUT_MSG_ID[OUT_MSG_ID["SET_SERVER_LOGLEVEL"] = 14] = "SET_SERVER_LOGLEVEL";
    OUT_MSG_ID[OUT_MSG_ID["REQ_AUTO_OPEN_ORDERS"] = 15] = "REQ_AUTO_OPEN_ORDERS";
    OUT_MSG_ID[OUT_MSG_ID["REQ_ALL_OPEN_ORDERS"] = 16] = "REQ_ALL_OPEN_ORDERS";
    OUT_MSG_ID[OUT_MSG_ID["REQ_MANAGED_ACCTS"] = 17] = "REQ_MANAGED_ACCTS";
    OUT_MSG_ID[OUT_MSG_ID["REQ_FA"] = 18] = "REQ_FA";
    OUT_MSG_ID[OUT_MSG_ID["REPLACE_FA"] = 19] = "REPLACE_FA";
    OUT_MSG_ID[OUT_MSG_ID["REQ_HISTORICAL_DATA"] = 20] = "REQ_HISTORICAL_DATA";
    OUT_MSG_ID[OUT_MSG_ID["EXERCISE_OPTIONS"] = 21] = "EXERCISE_OPTIONS";
    OUT_MSG_ID[OUT_MSG_ID["REQ_SCANNER_SUBSCRIPTION"] = 22] = "REQ_SCANNER_SUBSCRIPTION";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_SCANNER_SUBSCRIPTION"] = 23] = "CANCEL_SCANNER_SUBSCRIPTION";
    OUT_MSG_ID[OUT_MSG_ID["REQ_SCANNER_PARAMETERS"] = 24] = "REQ_SCANNER_PARAMETERS";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_HISTORICAL_DATA"] = 25] = "CANCEL_HISTORICAL_DATA";
    OUT_MSG_ID[OUT_MSG_ID["REQ_CURRENT_TIME"] = 49] = "REQ_CURRENT_TIME";
    OUT_MSG_ID[OUT_MSG_ID["REQ_REAL_TIME_BARS"] = 50] = "REQ_REAL_TIME_BARS";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_REAL_TIME_BARS"] = 51] = "CANCEL_REAL_TIME_BARS";
    OUT_MSG_ID[OUT_MSG_ID["REQ_FUNDAMENTAL_DATA"] = 52] = "REQ_FUNDAMENTAL_DATA";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_FUNDAMENTAL_DATA"] = 53] = "CANCEL_FUNDAMENTAL_DATA";
    OUT_MSG_ID[OUT_MSG_ID["REQ_CALC_IMPLIED_VOLAT"] = 54] = "REQ_CALC_IMPLIED_VOLAT";
    OUT_MSG_ID[OUT_MSG_ID["REQ_CALC_OPTION_PRICE"] = 55] = "REQ_CALC_OPTION_PRICE";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_CALC_IMPLIED_VOLAT"] = 56] = "CANCEL_CALC_IMPLIED_VOLAT";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_CALC_OPTION_PRICE"] = 57] = "CANCEL_CALC_OPTION_PRICE";
    OUT_MSG_ID[OUT_MSG_ID["REQ_GLOBAL_CANCEL"] = 58] = "REQ_GLOBAL_CANCEL";
    OUT_MSG_ID[OUT_MSG_ID["REQ_MARKET_DATA_TYPE"] = 59] = "REQ_MARKET_DATA_TYPE";
    OUT_MSG_ID[OUT_MSG_ID["REQ_POSITIONS"] = 61] = "REQ_POSITIONS";
    OUT_MSG_ID[OUT_MSG_ID["REQ_ACCOUNT_SUMMARY"] = 62] = "REQ_ACCOUNT_SUMMARY";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_ACCOUNT_SUMMARY"] = 63] = "CANCEL_ACCOUNT_SUMMARY";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_POSITIONS"] = 64] = "CANCEL_POSITIONS";
    OUT_MSG_ID[OUT_MSG_ID["VERIFY_REQUEST"] = 65] = "VERIFY_REQUEST";
    OUT_MSG_ID[OUT_MSG_ID["VERIFY_MESSAGE"] = 66] = "VERIFY_MESSAGE";
    OUT_MSG_ID[OUT_MSG_ID["QUERY_DISPLAY_GROUPS"] = 67] = "QUERY_DISPLAY_GROUPS";
    OUT_MSG_ID[OUT_MSG_ID["SUBSCRIBE_TO_GROUP_EVENTS"] = 68] = "SUBSCRIBE_TO_GROUP_EVENTS";
    OUT_MSG_ID[OUT_MSG_ID["UPDATE_DISPLAY_GROUP"] = 69] = "UPDATE_DISPLAY_GROUP";
    OUT_MSG_ID[OUT_MSG_ID["UNSUBSCRIBE_FROM_GROUP_EVENTS"] = 70] = "UNSUBSCRIBE_FROM_GROUP_EVENTS";
    OUT_MSG_ID[OUT_MSG_ID["START_API"] = 71] = "START_API";
    OUT_MSG_ID[OUT_MSG_ID["VERIFY_AND_AUTH_REQUEST"] = 72] = "VERIFY_AND_AUTH_REQUEST";
    OUT_MSG_ID[OUT_MSG_ID["VERIFY_AND_AUTH_MESSAGE"] = 73] = "VERIFY_AND_AUTH_MESSAGE";
    OUT_MSG_ID[OUT_MSG_ID["REQ_POSITIONS_MULTI"] = 74] = "REQ_POSITIONS_MULTI";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_POSITIONS_MULTI"] = 75] = "CANCEL_POSITIONS_MULTI";
    OUT_MSG_ID[OUT_MSG_ID["REQ_ACCOUNT_UPDATES_MULTI"] = 76] = "REQ_ACCOUNT_UPDATES_MULTI";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_ACCOUNT_UPDATES_MULTI"] = 77] = "CANCEL_ACCOUNT_UPDATES_MULTI";
    OUT_MSG_ID[OUT_MSG_ID["REQ_SEC_DEF_OPT_PARAMS"] = 78] = "REQ_SEC_DEF_OPT_PARAMS";
    OUT_MSG_ID[OUT_MSG_ID["REQ_SOFT_DOLLAR_TIERS"] = 79] = "REQ_SOFT_DOLLAR_TIERS";
    OUT_MSG_ID[OUT_MSG_ID["REQ_FAMILY_CODES"] = 80] = "REQ_FAMILY_CODES";
    OUT_MSG_ID[OUT_MSG_ID["REQ_MATCHING_SYMBOLS"] = 81] = "REQ_MATCHING_SYMBOLS";
    OUT_MSG_ID[OUT_MSG_ID["REQ_MKT_DEPTH_EXCHANGES"] = 82] = "REQ_MKT_DEPTH_EXCHANGES";
    OUT_MSG_ID[OUT_MSG_ID["REQ_SMART_COMPONENTS"] = 83] = "REQ_SMART_COMPONENTS";
    OUT_MSG_ID[OUT_MSG_ID["REQ_NEWS_ARTICLE"] = 84] = "REQ_NEWS_ARTICLE";
    OUT_MSG_ID[OUT_MSG_ID["REQ_NEWS_PROVIDERS"] = 85] = "REQ_NEWS_PROVIDERS";
    OUT_MSG_ID[OUT_MSG_ID["REQ_HISTORICAL_NEWS"] = 86] = "REQ_HISTORICAL_NEWS";
    OUT_MSG_ID[OUT_MSG_ID["REQ_HEAD_TIMESTAMP"] = 87] = "REQ_HEAD_TIMESTAMP";
    OUT_MSG_ID[OUT_MSG_ID["REQ_HISTOGRAM_DATA"] = 88] = "REQ_HISTOGRAM_DATA";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_HISTOGRAM_DATA"] = 89] = "CANCEL_HISTOGRAM_DATA";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_HEAD_TIMESTAMP"] = 90] = "CANCEL_HEAD_TIMESTAMP";
    OUT_MSG_ID[OUT_MSG_ID["REQ_MARKET_RULE"] = 91] = "REQ_MARKET_RULE";
    OUT_MSG_ID[OUT_MSG_ID["REQ_PNL"] = 92] = "REQ_PNL";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_PNL"] = 93] = "CANCEL_PNL";
    OUT_MSG_ID[OUT_MSG_ID["REQ_PNL_SINGLE"] = 94] = "REQ_PNL_SINGLE";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_PNL_SINGLE"] = 95] = "CANCEL_PNL_SINGLE";
    OUT_MSG_ID[OUT_MSG_ID["REQ_HISTORICAL_TICKS"] = 96] = "REQ_HISTORICAL_TICKS";
    OUT_MSG_ID[OUT_MSG_ID["REQ_TICK_BY_TICK_DATA"] = 97] = "REQ_TICK_BY_TICK_DATA";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_TICK_BY_TICK_DATA"] = 98] = "CANCEL_TICK_BY_TICK_DATA";
    OUT_MSG_ID[OUT_MSG_ID["REQ_COMPLETED_ORDERS"] = 99] = "REQ_COMPLETED_ORDERS";
    OUT_MSG_ID[OUT_MSG_ID["REQ_WSH_META_DATA"] = 100] = "REQ_WSH_META_DATA";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_WSH_META_DATA"] = 101] = "CANCEL_WSH_META_DATA";
    OUT_MSG_ID[OUT_MSG_ID["REQ_WSH_EVENT_DATA"] = 102] = "REQ_WSH_EVENT_DATA";
    OUT_MSG_ID[OUT_MSG_ID["CANCEL_WSH_EVENT_DATA"] = 103] = "CANCEL_WSH_EVENT_DATA";
    OUT_MSG_ID[OUT_MSG_ID["REQ_USER_INFO"] = 104] = "REQ_USER_INFO";
})(OUT_MSG_ID || (exports.OUT_MSG_ID = OUT_MSG_ID = {}));
/**
 * @@internal
 *
...
class Encoder {
  ...
  function tagValuesToTokens(tagValues: TagValue[]): unknown[] {
    ...
    impliedVolatilityOptions) {
        if (this.serverVersion < min_server_version_1.default.REQ_CALC_IMPLIED_VOLAT) {
            return this.emitError("It does not support calculate implied volatility requests.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
        if (this.serverVersion < min_server_version_1.default.TRADING_CLASS) {
            if (contract.tradingClass === undefined || contract.tradingClass === "") {
                return this.emitError("It does not support tradingClass parameter in calculateImpliedVolatility.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
            }
        }
        const version = 2;
        const tokens = [
    ...
    //reserved for future use, must be blank
    optionPriceOptions) {
        if (this.serverVersion < min_server_version_1.default.REQ_CALC_OPTION_PRICE) {
    ...
    cancelAccountSummary(reqId) {
        if (this.serverVersion < min_server_version_1.default.ACCT_SUMMARY) {
            return this.emitError("It not support account summary cancellation.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
        const version = 1;
    ...
    cancelCalculateImpliedVolatility(reqId) {
        if (this.serverVersion < min_server_version_1.default.CANCEL_CALC_IMPLIED_VOLAT) {
            return this.emitError("It does not support calculate implied volatility cancellation.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
        const version = 1;
    ...
    cancelCalculateOptionPrice(reqId) {
        if (this.serverVersion < min_server_version_1.default.CANCEL_CALC_OPTION_PRICE) {
            return this.emitError("It does not support calculate option price cancellation.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
        const version = 1;
    ...
    cancelFundamentalData(reqId) {
        if (this.serverVersion < min_server_version_1.default.FUNDAMENTAL_DATA) {
            return this.emitError("It does not support fundamental data requests.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
        const version = 1;
    ...
    cancelOrder(orderId, manualCancelOrderTime) {
        ...
        const tokens = [OUT_MSG_ID.CANCEL_ORDER, version, orderId];
        if (this.serverVersion >= min_server_version_1.default.MANUAL_ORDER_TIME)
    ...
    placeOrder(id, contract, order) {
        if (this.serverVersion < min_server_version_1.default.SCALE_ORDERS) {
            if (order.scaleInitLevelSize !== undefined ||
                order.scalePriceIncrement !== undefined) {
                return this.emitError("It does not support Scale orders.", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
        if (this.serverVersion < min_server_version_1.default.SSHORT_COMBO_LEGS) {
            contract.comboLegs?.forEach((comboLeg) => {
                if (comboLeg.shortSaleSlot || !!comboLeg.designatedLocation) {
                    return this.emitError("It does not support SSHORT flag for combo legs.", errorCode_1.ErrorCode.UPDATE_TWS, id);
                }
            });
        }
        if (this.serverVersion < min_server_version_1.default.WHAT_IF_ORDERS) {
            if (order.whatIf) {
                return this.emitError("It does not support what-if orders.", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
        if (this.serverVersion < min_server_version_1.default.DELTA_NEUTRAL) {
            if (contract.deltaNeutralContract) {
                return this.emitError("It does not support delta-neutral orders.", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
        if (this.serverVersion < min_server_version_1.default.SCALE_ORDERS2) {
            if (order.scaleSubsLevelSize !== undefined) {
                return this.emitError("It does not support Subsequent Level Size for Scale orders.", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
        ...
        if (this.serverVersion < min_server_version_1.default.NOT_HELD) {
            if (order.notHeld) {
                return this.emitError("It does not support notHeld parameter.", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
        if (this.serverVersion < min_server_version_1.default.SEC_ID_TYPE) {
            if (!!contract.secIdType || !!contract.secId) {
                return this.emitError("It does not support secIdType and secId parameters.", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
        if (this.serverVersion < min_server_version_1.default.PLACE_ORDER_CONID) {
            if (contract.conId != undefined) {
                return this.emitError("It does not support conId parameter.", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
        if (this.serverVersion < min_server_version_1.default.SSHORTX) {
            if (order.exemptCode !== -1) {
                return this.emitError("It does not support exemptCode parameter.", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
        if (this.serverVersion < min_server_version_1.default.SSHORTX) {
            contract.comboLegs?.forEach((comboLeg) => {
        ...
        if (this.serverVersion < min_server_version_1.default.OPT_OUT_SMART_ROUTING) {
            if (order.optOutSmartRouting) {
                return this.emitError("It does not support optOutSmartRouting parameter.", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
        if (this.serverVersion < min_server_version_1.default.DELTA_NEUTRAL_CONID) {
            if (order.deltaNeutralConId != undefined ||
                !!order.deltaNeutralSettlingFirm ||
                !!order.deltaNeutralClearingAccount ||
                !!order.deltaNeutralClearingIntent) {
                return this.emitError("It does not support deltaNeutral parameters: ConId, SettlingFirm, ClearingAccount, ClearingIntent.", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
        if (this.serverVersion < min_server_version_1.default.DELTA_NEUTRAL_OPEN_CLOSE) {
            if (!!order.deltaNeutralOpenClose ||
                order.deltaNeutralShortSale ||
                order.deltaNeutralShortSaleSlot != undefined ||
                !!order.deltaNeutralDesignatedLocation) {
                return this.emitError("It does not support deltaNeutral parameters: OpenClose, ShortSale, ShortSaleSlot, DesignatedLocation.", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
        if (this.serverVersion < min_server_version_1.default.SCALE_ORDERS3) {
            if (order.scalePriceIncrement != undefined &&
                ...
                if (order.scalePriceAdjustValue !== undefined ||
                    ...
                    return this.emitError("It does not support Scale order parameters: PriceAdjustValue, PriceAdjustInterval, ProfitOffset, AutoReset, InitPosition, InitFillQty and RandomPercent", errorCode_1.ErrorCode.UPDATE_TWS, id);
                }
            }
        }
        if (this.serverVersion < min_server_version_1.default.ORDER_COMBO_LEGS_PRICE &&
            sec_type_1.default.BAG === contract.secType?.toUpperCase()) {
            order.orderComboLegs?.forEach((orderComboLeg) => {
                if (orderComboLeg.price !== undefined) {
                    return this.emitError("It does not support per-leg prices for order combo legs.", errorCode_1.ErrorCode.UPDATE_TWS, id);
                }
            });
        }
        if (this.serverVersion < min_server_version_1.default.TRAILING_PERCENT) {
            if (order.trailingPercent !== undefined) {
                return this.emitError("It does not support trailing percent parameter.", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
        if (this.serverVersion < min_server_version_1.default.TRADING_CLASS) {
            if (!!contract.tradingClass) {
        ...
        if (this.serverVersion < min_server_version_1.default.SCALE_TABLE) {
            if (!!order.scaleTable ||
                !!order.activeStartTime ||
                !!order.activeStopTime) {
                return this.emitError("It does not support scaleTable, activeStartTime and activeStopTime parameters.", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
        if (this.serverVersion < min_server_version_1.default.ALGO_ID && !!order.algoId) {
            return this.emitError("It does not support algoId parameter", errorCode_1.ErrorCode.UPDATE_TWS, id);
        }
        if (this.serverVersion < min_server_version_1.default.SCALE_TABLE) {
            if (!!order.scaleTable ||
        ...
        if (this.serverVersion < min_server_version_1.default.ORDER_SOLICITED) {
            if (order.solicited) {
                return this.emitError("It does not support order solicited parameter.", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
        ...
        if (this.serverVersion < min_server_version_1.default.EXT_OPERATOR &&
            !!order.extOperator) {
            return this.emitError("It does not support ext operator", errorCode_1.ErrorCode.UPDATE_TWS, id);
        }
        if (this.serverVersion < min_server_version_1.default.SOFT_DOLLAR_TIER &&
            (!!order.softDollarTier?.name || !!order.softDollarTier?.value)) {
            return this.emitError("It does not support soft dollar tier", errorCode_1.ErrorCode.UPDATE_TWS, id);
        }
        if (this.serverVersion < min_server_version_1.default.CASH_QTY) {
            if (order.cashQty !== undefined) {
                return this.emitError("It does not support cash quantity parameter", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
        if (this.serverVersion < min_server_version_1.default.DECISION_MAKER &&
            (!!order.mifid2DecisionMaker || !!order.mifid2DecisionAlgo)) {
            return this.emitError("It does not support MIFID II decision maker parameters", errorCode_1.ErrorCode.UPDATE_TWS, id);
        }
        if (this.serverVersion < min_server_version_1.default.MIFID_EXECUTION &&
            (!!order.mifid2ExecutionTrader || !!order.mifid2ExecutionAlgo)) {
            return this.emitError("It does not support MIFID II execution parameters", errorCode_1.ErrorCode.UPDATE_TWS, id);
        }
        if (this.serverVersion < min_server_version_1.default.AUTO_PRICE_FOR_HEDGE &&
            order.dontUseAutoPriceForHedge) {
            return this.emitError("It does not support don't use auto price for hedge parameter.", errorCode_1.ErrorCode.UPDATE_TWS, id);
        }
        if (this.serverVersion < min_server_version_1.default.ORDER_CONTAINER &&
            order.isOmsContainer) {
            return this.emitError("It does not support oms container parameter.", errorCode_1.ErrorCode.UPDATE_TWS, id);
        }
        if (this.serverVersion < min_server_version_1.default.D_PEG_ORDERS &&
            order.discretionaryUpToLimitPrice) {
            return this.emitError("It does not support D-Peg orders.", errorCode_1.ErrorCode.UPDATE_TWS, id);
        }
        if (this.serverVersion < min_server_version_1.default.PRICE_MGMT_ALGO &&
            order.usePriceMgmtAlgo != null) {
            return this.emitError("It does not support price management algo parameter", errorCode_1.ErrorCode.UPDATE_TWS, id);
        }
        if (this.serverVersion < min_server_version_1.default.DURATION &&
            order.duration != undefined) {
            return this.emitError("It does not support duration attribute", errorCode_1.ErrorCode.UPDATE_TWS, id);
        }
        if (this.serverVersion < min_server_version_1.default.POST_TO_ATS &&
            order.postToAts != undefined) {
            return this.emitError("It does not support postToAts attribute", errorCode_1.ErrorCode.UPDATE_TWS, id);
        }
        if (this.serverVersion < min_server_version_1.default.AUTO_CANCEL_PARENT &&
            order.autoCancelParent != null) {
            return this.emitError("It does not support autoCancelParent attribute", errorCode_1.ErrorCode.UPDATE_TWS, id);
        }
        if (this.serverVersion < min_server_version_1.default.ADVANCED_ORDER_REJECT &&
            order.advancedErrorOverride != undefined) {
            return this.emitError("It does not support advanced error override attribute", errorCode_1.ErrorCode.UPDATE_TWS, id);
        }
        if (this.serverVersion < min_server_version_1.default.MANUAL_ORDER_TIME &&
            order.manualOrderTime?.length) {
            return this.emitError("It does not support manual order time attribute", errorCode_1.ErrorCode.UPDATE_TWS, id);
        }
        if (this.serverVersion < min_server_version_1.default.PEGBEST_PEGMID_OFFSETS &&
            ...
            return this.emitError("It does not support PEG BEST / PEG MID order parameters: minTradeQty, minCompeteSize, competeAgainstBestOffset, midOffsetAtWhole and midOffsetAtHalf", errorCode_1.ErrorCode.UPDATE_TWS, id);
        }
        if (this.serverVersion < min_server_version_1.default.CUSTOMER_ACCOUNT) {
            if (order.customerAccount) {
                return this.emitError("It does not support customer account parameter", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
        if (this.serverVersion < min_server_version_1.default.PROFESSIONAL_CUSTOMER) {
            if (order.professionalCustomer) {
                return this.emitError("It does not support professional customer parameter", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
        const version = this.serverVersion < min_server_version_1.default.NOT_HELD ? 27 : 45;
        // send place order msg
        const tokens = [OUT_MSG_ID.PLACE_ORDER];
        if (this.serverVersion < min_server_version_1.default.ORDER_CONTAINER) {
            tokens.push(version);
        }
        tokens.push(id);
        ...
        if (this.serverVersion >= min_server_version_1.default.SMART_COMBO_ROUTING_PARAMS &&
            sec_type_1.default.BAG === contract.secType?.toUpperCase()) {
        ...
        if (this.serverVersion >= 19) {
            ...
            const lower = this.serverVersion === 26 && (0, orderType_1.isVolOrder)(order.orderType)
                ? undefined
                : order.stockRangeLower;
            const upper = this.serverVersion === 26 && (0, orderType_1.isVolOrder)(order.orderType)
                ? undefined
        ...
        if (this.serverVersion >= 26) {
            ...
            if (this.serverVersion === 26) {
                // Volatility orders had specific watermark price attribs in server version 26
                const lower = (0, orderType_1.isVolOrder)(order.orderType)
                    ? order.stockRangeLower
                    : undefined;
                const upper = (0, orderType_1.isVolOrder)(order.orderType)
                    ? order.stockRangeUpper
                    : undefined;
        ...
        if (this.serverVersion >= min_server_version_1.default.PTA_ORDERS) {
        ...
        if (this.serverVersion >= min_server_version_1.default.ALGO_ID) {
        ...
        if (this.serverVersion >= min_server_version_1.default.RANDOMIZE_SIZE_AND_PRICE) {
        ...
        if (this.serverVersion >= min_server_version_1.default.PEGGED_TO_BENCHMARK) {
            if ((0, orderType_1.isPegBenchOrder)(order.orderType)) {
        ...
        if (this.serverVersion >= min_server_version_1.default.PEGBEST_PEGMID_OFFSETS) {
            ...
            if ((0, orderType_1.isPegBestOrder)(order.orderType)) {
                ...
                if ((0, order_1.isCompeteAgainstBestOffsetUpToMid)(order))
                    sendMidOffsets = true;
            }
            else if ((0, orderType_1.isPegMidOrder)(order.orderType)) {
                sendMidOffsets = true;
            }
            if (sendMidOffsets) {
    ...
    replaceFA(reqId, faDataType, xml) {
        ...
        const version = 1;
        const tokens = [OUT_MSG_ID.REPLACE_FA, version, faDataType, xml];
        if (this.serverVersion >= min_server_version_1.default.REPLACE_FA_END) {
            tokens.push(reqId);
        }
        this.sendMsg(tokens);
    }
    ...
    reqAccountSummary(reqId, group, tags) {
        if (this.serverVersion < min_server_version_1.default.ACCT_SUMMARY) {
            return this.emitError("It does not support account summary requests.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
        const version = 1;
    ...
    reqPnL(reqId, account, modelCode) {
        if (this.serverVersion < min_server_version_1.default.PNL) {
            return this.emitError("It does not support pnl requests.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
    ...
    reqAccountUpdates(subscribe, acctCode) {
        const version = 2;
        const tokens = [OUT_MSG_ID.REQ_ACCOUNT_DATA, version, subscribe];
    ...
    reqHeadTimestamp(reqId, contract, whatToShow, useRTH, formatDate) {
        if (this.serverVersion < min_server_version_1.default.REQ_HEAD_TIMESTAMP) {
            return this.emitError("It does not support reqHeadTimeStamp", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
        this.sendMsg(OUT_MSG_ID.REQ_HEAD_TIMESTAMP, reqId, this.encodeContract(contract), useRTH ? 1 : 0, whatToShow, formatDate);
    }
    /**
    ...
    reqContractDetails(reqId, contract) {
        if (this.serverVersion < 4) {
            return this.emitError("This feature is only available for versions of TWS >=4", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
        if (this.serverVersion < min_server_version_1.default.SEC_ID_TYPE) {
            if (!!contract.secIdType || !!contract.secId) {
                return this.emitError("It does not support secIdType and secId parameters.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
            }
        }
        if (this.serverVersion < min_server_version_1.default.TRADING_CLASS) {
            if (!!contract.tradingClass) {
        ...
        if (this.serverVersion < min_server_version_1.default.BOND_ISSUERID) {
            if (contract.issuerId) {
                return this.emitError("It does not support issuerId parameter in reqContractDetails.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
            }
        }
        const version = 8;
        // send req mkt data msg
        const args = [OUT_MSG_ID.REQ_CONTRACT_DATA, version];
        if (this.serverVersion >= min_server_version_1.default.CONTRACT_DATA_CHAIN) {
            args.push(reqId);
        }
        // send contract fields
        if (this.serverVersion >= min_server_version_1.default.CONTRACT_CONID) {
        ...
        if (this.serverVersion >= min_server_version_1.default.PRIMARYEXCH) {
            args.push(contract.exchange);
            args.push(contract.primaryExch);
        }
        else if (this.serverVersion >= min_server_version_1.default.LINKING) {
            if (!!contract.primaryExch &&
    ...
    reqExecutions(reqId, filter) {
        ...
        const args = [OUT_MSG_ID.REQ_EXECUTIONS, version];
        if (this.serverVersion >= min_server_version_1.default.EXECUTION_DATA_CHAIN) {
            args.push(reqId);
        }
    ...
    reqFundamentalData(reqId, contract, reportType, fundamentalDataOptions) {
        ...
        if (this.serverVersion < min_server_version_1.default.TRADING_CLASS) {
            if (contract.conId != undefined) {
                return this.emitError("It does not support conId parameter in reqFundamentalData.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
            }
        }
        const version = 2;
        // send req fund data msg
        const tokens = [OUT_MSG_ID.REQ_FUNDAMENTAL_DATA, version, reqId];
        // send contract fields
        if (this.serverVersion >= min_server_version_1.default.TRADING_CLASS) {
            tokens.push(contract.conId);
        }
    ...
    reqGlobalCancel() {
        if (this.serverVersion < min_server_version_1.default.REQ_GLOBAL_CANCEL) {
            return this.emitError("It does not support globalCancel requests.", errorCode_1.ErrorCode.UPDATE_TWS, -1);
        }
        const version = 1;
    ...
    reqHistoricalData(tickerId, contract, endDateTime, durationStr, barSizeSetting, whatToShow, useRTH, formatDate, keepUpToDate, chartOptions) {
        ...
        if (sec_type_1.default.BAG === contract.secType?.toUpperCase()) {
     ...
     */
    encodeReqTickByTickData(reqId, contract, tickType, numberOfTicks, ignoreSize) {
        const args = [OUT_MSG_ID.REQ_TICK_BY_TICK_DATA, reqId];
        args.push(contract.conId);
        args.push(contract.symbol);
        args.push(contract.secType);
        args.push(contract.lastTradeDateOrContractMonth);
        ...
        args.push(contract.tradingClass);
        args.push(tickType);
        if (this.serverVersion >= min_server_version_1.default.TICK_BY_TICK_IGNORE_SIZE) {
            args.push(numberOfTicks);
            args.push(ignoreSize);
        }
        return args;
    ...
    reqTickByTickData(reqId, contract, tickType, numberOfTicks, ignoreSize) {
        if (this.serverVersion < min_server_version_1.default.TICK_BY_TICK) {
            this.emitError("It does not support tick-by-tick data requests.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
        else if (this.serverVersion < min_server_version_1.default.TICK_BY_TICK_IGNORE_SIZE &&
            (numberOfTicks != 0 || ignoreSize)) {
            this.emitError("It does not support ignoreSize and numberOfTicks parameters in tick-by-tick data requests.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
        else {
            const args = this.encodeReqTickByTickData(reqId, contract, tickType, numberOfTicks, ignoreSize);
            this.sendMsg(args);
        }
    }
    /**
    ...
    cancelTickByTickData(reqId) {
        if (this.serverVersion < min_server_version_1.default.TICK_BY_TICK) {
            return this.emitError("It does not support tick-by-tick data cancels.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
    ...
    reqMarketDataType(marketDataType) {
        if (this.serverVersion < min_server_version_1.default.REQ_MARKET_DATA_TYPE) {
            return this.emitError("It does not support marketDataType requests.", errorCode_1.ErrorCode.UPDATE_TWS, -1);
        }
        const version = 1;
    ...
    reqMktData(tickerId, contract, genericTickList, snapshot, regulatorySnapshot) {
        ...
        if (this.serverVersion >= min_server_version_1.default.SNAPSHOT_MKT_DATA) {
            args.push(snapshot);
        }
    ...
    reqPositions() {
        if (this.serverVersion < min_server_version_1.default.ACCT_SUMMARY) {
            return this.emitError("It does not support position requests.", errorCode_1.ErrorCode.UPDATE_TWS, -1);
        }
        const version = 1;
    ...
    reqPositionsMulti(reqId, account, modelCode) {
        if (this.serverVersion < min_server_version_1.default.MODELS_SUPPORT) {
            return this.emitError("It does not support position requests.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
        const version = 1;
    ...
    cancelPositionsMulti(reqId) {
        if (this.serverVersion < min_server_version_1.default.MODELS_SUPPORT) {
            return this.emitError("It does not support positions multi cancellation.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
        const version = 1;
    ...
    reqScannerParameters() {
        if (this.serverVersion < 24) {
            return this.emitError("It does not support API scanner subscription.", errorCode_1.ErrorCode.UPDATE_TWS, -1);
        }
        const version = 1;
    ...
    reqScannerSubscription(reqId, subscription, scannerSubscriptionOptions, scannerSubscriptionFilterOptions) {
        ...
        if (this.serverVersion < min_server_version_1.default.SCANNER_GENERIC_OPTS &&
            scannerSubscriptionFilterOptions) {
            return this.emitError("It does not support API scanner subscription generic filter options.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
        const version = 4;
        const tokens = [OUT_MSG_ID.REQ_SCANNER_SUBSCRIPTION];
        if (this.serverVersion < min_server_version_1.default.SCANNER_GENERIC_OPTS) {
            tokens.push(version);
        }
        tokens.push(reqId);
        ...
        tokens.push(market_scanner_1.ScanCode[subscription.scanCode]);
    ...
    reqSecDefOptParams(reqId, underlyingSymbol, futFopExchange, underlyingSecType, underlyingConId) {
        if (this.serverVersion < min_server_version_1.default.SEC_DEF_OPT_PARAMS_REQ) {
            return this.emitError("It does not support reqSecDefOptParams.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
    ...
    reqSoftDollarTiers(reqId) {
        if (this.serverVersion < min_server_version_1.default.SOFT_DOLLAR_TIER) {
            return this.emitError("It does not support soft dollar tier requests.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
    ...
    reqFamilyCodes() {
        if (this.serverVersion < min_server_version_1.default.REQ_FAMILY_CODES) {
            return this.emitError("It does not support family codes request.", errorCode_1.ErrorCode.UPDATE_TWS, -1);
        }
    ...
    reqMatchingSymbols(reqId, pattern) {
        if (this.serverVersion < min_server_version_1.default.REQ_MATCHING_SYMBOLS) {
            return this.emitError("It does not support matching symbols request.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
    ...
    reqMktDepthExchanges() {
        if (this.serverVersion < min_server_version_1.default.REQ_MKT_DEPTH_EXCHANGES) {
            return this.emitError("It does not support market depth exchanges request.", errorCode_1.ErrorCode.UPDATE_TWS, -1);
        }
    ...
    reqSmartComponents(reqId, bboExchange) {
        if (this.serverVersion < min_server_version_1.default.REQ_SMART_COMPONENTS) {
            return this.emitError("It does not support smart components request.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
    ...
    reqNewsArticle(reqId, providerCode, articleId, newsArticleOptions) {
        if (this.serverVersion < min_server_version_1.default.REQ_NEWS_ARTICLE) {
            return this.emitError("It does not support news article request.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
        const tokens = [
        ...
        if (this.serverVersion >= min_server_version_1.default.NEWS_QUERY_ORIGINS) {
    ...
    reqNewsProviders() {
        if (this.serverVersion < min_server_version_1.default.REQ_SMART_COMPONENTS) {
            return this.emitError("It does not support smart components request.", errorCode_1.ErrorCode.UPDATE_TWS, -1);
        }
    ...
    reqHistoricalNews(reqId, conId, providerCodes, startDateTime, endDateTime, totalResults, historicalNewsOptions) {
        if (this.serverVersion < min_server_version_1.default.REQ_HISTORICAL_NEWS) {
            return this.emitError("It does not support historical news request.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
        const tokens = [
    ...
    reqCompletedOrders(apiOnly) {
        if (this.serverVersion < min_server_version_1.default.REQ_COMPLETED_ORDERS) {
            return this.emitError("It does not support completed orders requests.", errorCode_1.ErrorCode.UPDATE_TWS, -1);
        }
        this.sendMsg(OUT_MSG_ID.REQ_COMPLETED_ORDERS, apiOnly);
    }
    reqWshMetaData(reqId) {
        if (this.serverVersion < min_server_version_1.default.WSHE_CALENDAR) {
            return this.emitError("It does not support WSHE Calendar API.", errorCode_1.ErrorCode.UPDATE_TWS, -1);
        }
    ...
    reqWshEventData(reqId, wshEventData) {
        ...
        if (this.serverVersion < min_server_version_1.default.WSH_EVENT_DATA_FILTERS &&
            (wshEventData.filter?.length ||
                wshEventData.fillWatchlist ||
                wshEventData.fillPortfolio ||
                wshEventData.fillCompetitors)) {
            return this.emitError("It does not support WSH event data filters.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
        if (this.serverVersion < min_server_version_1.default.WSH_EVENT_DATA_FILTERS_DATE &&
            (wshEventData.startDate ||
                wshEventData.endDate ||
                wshEventData.totalLimit)) {
            return this.emitError("It does not support WSH event data date filters.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
        const tokens = [
    ...
    reqUserInfo(reqId) {
        if (this.serverVersion < min_server_version_1.default.USER_INFO) {
            return this.emitError("It does not support user info requests.", errorCode_1.ErrorCode.UPDATE_TWS, -1);
        }
